...
if __name__ == '__main__':
    ...
    sample_analysis = [
        VisualSegmentAnalysis(
            ...
            shot_type="B-roll",
            spoken_text="In this video, we'll explore the beautiful mountains.",
            visual_description="A wide shot of a mountain range at sunrise.",
            inferred_purpose="Establishes the setting and mood of the video.",
            effectiveness_rating=5,
            effectiveness_justification="Visually stunning and sets a clear context."
        ),
        VisualSegmentAnalysis(
            video_filename="example_video.mp4",
            ...
            spoken_text="The key is to use a variety of shots to keep the viewer engaged.",
            visual_description="A medium shot of the presenter speaking directly to the camera.",
            inferred_purpose="Creates a personal connection with the viewer.",
            effectiveness_rating=4,
            effectiveness_justification="Direct address is engaging, but the background is a bit plain."
        )
    ]
